...
<?php echo $__env->yieldContent('title_postfix', config('adminlte.title_postfix', '')); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('js/jquery-ui.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('vendor/adminlte/vendor/datatables/dataTables.bootstrap.min.css')); ?>">
    <?php endif; ?>
...
<script src="<?php echo e(asset('vendor/adminlte/vendor/notify/notify.js')); ?>"></script>
<script src="<?php echo e(asset('vendor/adminlte/vendor/vuejs/vue.js')); ?>"></script>
<script src="<?php echo e(asset('vendor/adminlte/vendor/axios/axios.js')); ?>"></script>
...
<?php if(config('adminlte.plugins.datatables')): ?>
    ...
    <script src="<?php echo e(asset('vendor/adminlte/vendor/datatables/jquery.dataTables.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/adminlte/vendor/datatables/dataTables.bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/adminlte/vendor/datatables/dataTables.editor.min.js')); ?>"></script>
<?php endif; ?>
