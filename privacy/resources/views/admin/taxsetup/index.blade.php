            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            {{ Form::label('kode_pajak', 'Kode Pajak:') }}
                            {{ Form::text('kode_pajak', null, ['class'=> 'form-control','id'=>'Kode2','readonly','required'=>'required', 'autocomplete'=>'off']) }}
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
                            {{ Form::label('nama_pajak', 'Nama Pajak:') }}
                            {{ Form::text('nama_pajak', null, ['class'=> 'form-control','id'=>'Nama2','required'=>'required', 'autocomplete'=>'off']) }}
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
