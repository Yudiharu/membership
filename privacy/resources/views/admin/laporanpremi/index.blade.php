        ...
        <div class="modal fade" id="button4"  role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                {!! Form::open(['route' => ['laporanpremi.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]) !!}
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            {{ Form::label('jenis', 'Tahun Periode:') }} 
                                            {{ Form::selectYear('tahun', 2021, 2040, null, ['class'=> 'form-control select2','id'=>'namatahun','placeholder'=>'','style'=>'width: 100%','required'])}}
                                        </div>
                                    </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        {{ Form::label('tipe', 'Jenis Rekap:') }}
                                        {{ Form::select('jenis_rekap', ['BANK'=>'BANK', 'CASH' => 'CASH'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'jen1','required'])}}
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
