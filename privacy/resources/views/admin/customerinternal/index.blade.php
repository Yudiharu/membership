...
@section('title', 'Customer Internal')
            ...
            {!! Form::open(['id'=>'ADD']) !!}
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    {{ Form::label('Nama Customer', 'Nama Customer Di Faktur:') }}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    {{ Form::label('coas', 'Account:') }}
                                    {{Form::select('kode_coa', $Coa->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Coa1','required'=>'required'])}}
                                </div>
                            </div>
                            <!-- <div class="col-md-12">
                                <div class="form-group">
                                    {{ Form::label('alamat', 'Alamat:') }}
                                    {{ Form::text('alamat', null, ['class'=> 'form-control','id'=>'Alamat1', 'placeholder'=>'Alamat 1','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Maksimal 50 Karakter",'required']) }}
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    {{ Form::text('alamat2', null, ['class'=> 'form-control','id'=>'Alamat1a', 'placeholder'=>'Alamat 2','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Maksimal 50 Karakter"]) }}
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    {{ Form::text('alamat3', null, ['class'=> 'form-control','id'=>'Alamat1b', 'placeholder'=>'Alamat 3','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Maksimal 50 Karakter"]) }}
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    {{ Form::text('alamat4', null, ['class'=> 'form-control','id'=>'Alamat1c', 'placeholder'=>'Alamat 4','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Maksimal 50 Karakter"]) }}
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('kode_pos', 0, ['class'=> 'form-control','id'=>'Kodepos1','required'=>'required', 'placeholder'=>'Kode Pos','autocomplete'=>'off', 'maxlength'=>'5','onkeypress'=>"return hanyaAngka(event)"]) }}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('telp', '(    )-', ['class'=> 'form-control','id'=>'Telp1','required'=>'required', 'placeholder'=>'No. Telepon','autocomplete'=>'off','onkeypress'=>"return hanyaAngka(event)"]) }}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('hp', '(    )-', ['class'=> 'form-control','id'=>'Hp1','required'=>'required', 'placeholder'=>'No. HP','autocomplete'=>'off','onkeypress'=>"return hanyaAngka(event)", 'name'=>'hp']) }}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('fax', '(    )-', ['class'=> 'form-control','id'=>'Fax1','required'=>'required', 'placeholder'=>'No. FAX','autocomplete'=>'off','onkeypress'=>"return hanyaAngka(event)"]) }}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('npwp', '.   .   . -   .', ['class'=> 'form-control','id'=>'Npwp1', 'placeholder'=>'NPWP','autocomplete'=>'off','onkeypress'=>"return hanyaAngka(event)", 'name'=>'npwp']) }}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('nama_kontak', 'Nama PIC:') }}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('contact_pic', '(    )-', ['class'=> 'form-control','id'=>'contact1','required'=>'required', 'placeholder'=>'No. HP PIC','autocomplete'=>'off','onkeypress'=>"return hanyaAngka(event)", 'name'=>'contact_pic']) }}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('type_company', 'Type Company:') }}
                                    {{Form::select('type_company', ['1' => 'Swasta', '2' => 'BUMN'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'compa1','required'=>'required'])}}
                                </div>
                            </div>
                ...
                <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    {{ Form::label('Nama customer', 'Nama Customer:') }}
                                    {{ Form::text('nama_customer', null, ['class'=> 'form-control','id'=>'Nama','required'=>'required', 'placeholder'=>'Contoh: NAMA CUSTOMER, CV','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Contoh: NAMA CUSTOMER, CV"]) }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('nama_customer_po', null, ['class'=> 'form-control','id'=>'Namapo','required'=>'required', 'placeholder'=>'Contoh: CV. NAMA CUSTOMER','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Contoh: CV. NAMA CUSTOMER"]) }}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    {{ Form::label('coas', 'Account:') }}
                                    {{Form::select('kode_coa', $Coa->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Coa2','required'=>'required'])}}
                                </div>
                            </div>
...
@push('js')
    ...
    function pulsar(e,obj) {            
        ...
        $(function() {          
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('customerinternal.data') !!}',
            columns: [
        ...
        $(document).ready(function(){
            ...
            $('#editcustomer').click( function () {
                ...
                $.ajax({
                    url: '{!! route('customerinternal.edit_customer') !!}',
                    type: 'POST',
                    data : {
                        'id': kode_customer
                    },
            ...
            $('#hapuscustomer').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '{!! route('customerinternal.hapus_customer') !!}',
                            type: 'POST',
                            data : {
                                'id': kode_customer
                            },
        ...
        $('#ADD').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'{!! route('customerinternal.store') !!}',
                    type:'POST',
                    data:formData,
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'{!! route('customerinternal.ajaxupdate') !!}',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
