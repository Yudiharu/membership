                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            {{ Form::label('catatan', 'Kode Setup:') }}
                            {{ Form::text('kode_setup', null, ['class'=> 'form-control','id'=>'Nama1','required'=>'required', 'placeholder'=>'Nama Setup','onkeypress'=>"return pulsar(event,this)"]) }}
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            {{ Form::label('catatan', 'Jumlah Hari:') }}
                            {{ Form::text('hari', 0, ['class'=> 'form-control','id'=>'Hari1','required'=>'required', 'placeholder'=>'Jumlah selisih hari']) }}
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="editform" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                {{ Form::hidden('id', null, ['class'=> 'form-control','id'=>'Nomor','readonly']) }}
                    <div class="col-md-6">
                        <div class="form-group">
                            {{ Form::label('catatan', 'Kode Setup:') }}
                            {{ Form::text('kode_setup', null, ['class'=> 'form-control','id'=>'Nama2','required'=>'required', 'placeholder'=>'Nama Setup','onkeypress'=>"return pulsar(event,this)"]) }}
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            {{ Form::label('catatan', 'Jumlah Hari:') }}
                            {{ Form::text('hari', 0, ['class'=> 'form-control','id'=>'Hari2','required'=>'required', 'placeholder'=>'Jumlah selisih hari']) }}
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#edittanggalsetup').click( function () {
                ...
                $.ajax({
                    url: '{!! route('tanggalsetup.edit_tanggalsetup') !!}',
                    type: 'POST',
                    data : {
                        'id': nomor
                    },
            ...
            $('#hapustanggalsetup').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '{!! route('tanggalsetup.hapus_tanggalsetup') !!}',
                            type: 'POST',
                            data : {
                                'id': nomor
                            },
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'{!! route('tanggalsetup.ajaxupdate') !!}',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
