        ...
        <div class="modal fade" id="button4"  role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                {!! Form::open(['route' => ['laporanrekapjo.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]) !!}
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        {{ Form::label('tipe', 'Jenis JO:') }}
                                        {{ Form::select('jenis_jo', ['SEMUA'=>'SEMUA', '1' => 'Non-Transhipment','2' => 'Transhipment'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'jen1','required'])}}
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
