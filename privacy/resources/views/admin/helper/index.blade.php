            ...
            <div class="box ">
                <div class="box-body">
                    ...
                    <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#addform">
                        <i class="fa fa-plus"></i> New Helper</button>
                    @endpermission
                    <span class="pull-right">
                        <b>Keterangan Warna:&nbsp;&nbsp;&nbsp;&nbsp;</b>
                        <font style="background-color:#5CB8FB;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>&nbsp;:&nbsp;Status Insentif.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <font style="font-size: 16px;"><b>HELPER</b></font>
                    </span>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    {{ Form::label('Nama', 'Nama Helper:') }}
                                    {{ Form::text('nama_helper', null, ['class'=> 'form-control','id'=>'Nama1','required'=>'required', 'placeholder'=>'Nama Helper','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"]) }}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
    ...
    <div class="modal fade" id="editform" role="dialog">
            ...
            {!! Form::open(['id'=>'EDIT']) !!}
                <div class="modal-body">
                        ...
                        {{ Form::hidden('id', null, ['class'=> 'form-control','id'=>'Kode','readonly']) }}
                            <div class="col-md-8">
                                <div class="form-group">
                                    {{ Form::label('nama_sopir', 'Nama Helper:') }}
                                    {{ Form::text('nama_helper', null, ['class'=> 'form-control','id'=>'Nama2','required'=>'required', 'placeholder'=>'Nama Helper','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)",'readonly']) }}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
      ...
      <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i>{{ $nama_company }}</i> <b>({{ $nama_lokasi }})</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <button type="button" class="btn btn-warning btn-xs edit-button" id="edithelper" data-toggle="modal" data-target="">EDIT <i class="fa fa-edit"></i></button>
            @endpermission

            @permission('delete-helper')
            <button type="button" class="btn btn-danger btn-xs hapus-button" id="hapushelper" data-toggle="modal" data-target="">HAPUS <i class="fa fa-times-circle"></i></button>
            @endpermission
        </div>
</body>
@stop
    ...
    $(function() {   
        $('#data-table').DataTable({
            ...
            columns: [
                ...
                { data: 'nama_helper', name: 'nama_helper' },
                { data: 'nik', name: 'nik' },
                { data: 'alamat', name: 'alamat' },
                { data: 'telp', name: 'telp' },
                { data: 'kode_pos', name: 'kode_pos' },
                { data: 'bank.nama_bank', "defaultContent": "<i>-</i>" },
