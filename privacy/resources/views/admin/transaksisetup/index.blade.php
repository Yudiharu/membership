            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            {{ Form::label('kode_transaksi', 'Kode Transaksi:') }}
                            {{ Form::text('kode_transaksi', null, ['class'=> 'form-control','id'=>'Kode_e','readonly','required'=>'required']) }}
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
                            {{ Form::label('nama_transaksi', 'Nama Transaksi:') }}
                            {{ Form::text('nama_transaksi', null, ['class'=> 'form-control','id'=>'Nama_e','required'=>'required','autocomplete'=>'off']) }}
                        </div>
                    </div>
                </div>
            </div>
