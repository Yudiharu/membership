                ...
                <div class="col-md-6">
                   <div class="box">
                       ...
                       <div class="box-body">
                           ...
                           <div class="form-group">
                               <label class="col-sm-8">
                                   {{ Form::selectYear('year', 2000, 2040, null, ['class'=> 'form-control select3','id'=>'namatahun','placeholder'=>'','style'=>'width: 100%'])}}
                               </label>
                           </div>
                           <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="box">
                        ...
                        <div class="box-body">
                           ...
                           <div class="form-group">
                               <label class="col-sm-8">
                                   {{ Form::selectYear('year2', 2000, 2040, $info_tahun, ['class'=> 'form-control select3','id'=>'namatahun2','placeholder'=>'','style'=>'width: 100%'])}}
                               </label>
                           </div>
                           <div class="form-group">
                               <label class="col-sm-4">
