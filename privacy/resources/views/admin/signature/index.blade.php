            ...
            {!! Form::open(['id'=>'ADD']) !!}
                    <div class="modal-body">
                        <div class="row">
                            ...
                            {{ Form::hidden('limit_dari', 0, ['class'=> 'form-control','id'=>'dari1','required'=>'required', 'placeholder'=>'Limit Dari', 'autocomplete'=>'off','onkeypress'=>"return hanyaAngka(event)"]) }}

                            {{ Form::hidden('limit_sampai', 0, ['class'=> 'form-control','id'=>'sampai1','required'=>'required', 'placeholder'=>'Limit Sampai', 'autocomplete'=>'off','onkeypress'=>"return hanyaAngka(event)"]) }}
                    </div>
                    </div>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            {{ Form::label('mengetahui', 'Mengetahui:') }}
                            {{ Form::text('mengetahui', null, ['class'=> 'form-control','id'=>'Mengetahui', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"]) }}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            {{ Form::label('jabatan', 'Jabatan:') }}
                            {{ Form::text('jabatan', null, ['class'=> 'form-control','id'=>'Jabatan', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"]) }}
                        </div>
                    </div>
                    
                    {{ Form::hidden('limit_dari', null, ['class'=> 'form-control','id'=>'dari','required'=>'required', 'placeholder'=>'Limit Dari', 'autocomplete'=>'off','onkeypress'=>"return hanyaAngka(event)"]) }}
                            
                    {{ Form::hidden('limit_sampai', null, ['class'=> 'form-control','id'=>'sampai','required'=>'required', 'placeholder'=>'Limit Sampai', 'autocomplete'=>'off','onkeypress'=>"return hanyaAngka(event)"]) }}
                </div>
            </div>
            <div class="modal-footer">
                <div class="row">
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            columns: [
                ...
                { data: 'limit_dari', name: 'limit_dari', visible: false },
                { data: 'limit_sampai', name: 'limit_sampai', visible: false },
            ]
            });
        });
