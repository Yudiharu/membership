...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Mobil <b>{{$cust->nopol}}</b></font>
    </span>
@include('sweet::alert')
<body onLoad="load()">
    <div class="box box-danger">
        <div class="box-body"> 
            ...
            <center><kbd>ADD FORM</kbd></center><br>
                <div class="row">
                {{ Form::hidden('kode_mobil',$cust->kode_mobil, ['class'=> 'form-control','readonly','id'=>'KodeCust1']) }}
                {{ Form::hidden('id', null, ['class'=> 'form-control','readonly','id'=>'Id1']) }}
                    <div class="col-md-3">
                        <div class="form-group">
                            {{ Form::label('Nomors', 'No Polisi Mobil:') }}
                            {{ Form::text('noomor', $cust->nopol, ['class'=> 'form-control','id'=>'Nama1','readonly']) }}
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
...
<script>
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            processing: true,
            serverSide: true,
            ajax:'https://aplikasi.gui-group.co.id/gui_front_pbm_laravel_trial/admin/mobil/getDatabyID?kode_customer='+kode,
            data:{'kode':kode},
            columns: [
    ...
    function formatStatus(n) {
        ...
        $('#ADD_DETAIL').submit(function (e) {
            ...
            $.ajax({
                url:'{!! route('mobil.store_lokasi') !!}',
                type:'POST',
                data:formData,
                success:function(data) {
                    console.log(data);
                    $('#TglBerlaku1').val('').trigger('change');
                    $('#Npwp1').val('');
                    $('#Alamat1').val('');
                    refreshTable();
