...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Lokasi Alat <b>{{$cust->no_asset_alat}}</b></font>
    </span>
@include('sweet::alert')
    ...
    <div class="box box-danger">
        <div class="box-body"> 
            ...
            <center><kbd>ADD FORM</kbd></center><br>
                <div class="row">
                {{ Form::hidden('kode_alat',$cust->kode_alat, ['class'=> 'form-control','readonly','id'=>'KodeCust1']) }}
                {{ Form::hidden('id', null, ['class'=> 'form-control','readonly','id'=>'Id1']) }}
                    <div class="col-md-3">
                        <div class="form-group">
                            {{ Form::label('Nomors', 'No Asset Alat:') }}
                            {{ Form::text('noomor', $cust->no_asset_alat, ['class'=> 'form-control','id'=>'Nama1','readonly']) }}
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
...
<script>
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            processing: true,
            serverSide: true,
            ajax:link+'/gui_front_02/admin/alat/getDatabyID?kode_customer='+kode,
            data:{'kode':kode},
            columns: [
