...
@section('title', 'Rekap SPB/Tgl Kembali SPB')
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">Rekap SPB <b>/Tanggal Kembali SPB</b></h4>
                </div>
                @include('errors.validation')
                {!! Form::open(['route' => ['laporanrekap_pertgl.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]) !!}
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            {{ Form::label('tanggal_awal', 'SPB Kembali Dari:') }}
                                            {{ Form::date('tanggal_awal',\Carbon\Carbon::now(), ['class'=> 'form-control','id'=>'tanggal1']) }}
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            {{ Form::label('tanggal_akhir', 'SPB Kembali Sampai:') }}
                                            {{ Form::date('tanggal_akhir',\Carbon\Carbon::now(), ['class'=> 'form-control','id'=>'tanggal2']) }}
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            {{ Form::label('type', 'Type SPB:') }}
                                            {{Form::select('type', ['Container' => 'Container', 'Non-Container' => 'Non-Container'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'type1','required'=>'required'])}}
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
