...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Job Request <b>{{$joborder->no_joborder}}</b></font>
    </span>
@include('sweet::alert')
    ...
    <div class="box box-danger">
        <div class="box-body">
            <div class="addform">
                ...
                {!! Form::open(['id'=>'ADD_REQUEST']) !!}
                <center><kbd>ADD FORM</kbd></center><br>
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            {{ Form::label('no_joborder', 'No Job Order:') }}
                            {{ Form::text('no_joborder',$joborder->no_joborder, ['class'=> 'form-control','readonly','id'=>'nojoborder','required']) }}
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            {{ Form::label('tanggal_req', 'Tanggal Job Request:') }}
                            {{ Form::date('tanggal_req', \Carbon\Carbon::now(), ['class'=> 'form-control','id'=>'tanggalreq','required']) }}
                        </div>
                    </div>
                </div> 
                <span class="pull-right"> 
                    {{ Form::submit('Buat Job Request', ['class' => 'btn btn-success btn-sm','id'=>'submit']) }}  
                </span>
                {!! Form::close() !!}    
            </div>
            ...
            <div class="editform">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            {{ Form::label('no_jobrequest', 'No Request JO:') }}
                            {{ Form::text('no_jobrequest',null, ['class'=> 'form-control','readonly','id'=>'noreqjo2']) }}
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            {{ Form::label('tanggal_req', 'Tanggal Request:') }}
                            {{ Form::date('tanggal_req',null, ['class'=> 'form-control','id'=>'tanggalreq2','required']) }}
                        </div>
                    </div>
                </div> 
                <div class="row-md-2">
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="box-body"> 
            <div class="addform">
                @include('errors.validation')
                {!! Form::open(['id'=>'ADD_TRUCKING']) !!}
                <div class="col-md-3">
                    <div class="form-group">
                        {{ Form::label('no_joborder', 'No Job Order:') }}
                        {{ Form::text('no_joborder',null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'nojoborder3','required','readonly']) }}
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        {{ Form::label('no_jobrequest', 'No Request JO:') }}
                        {{ Form::text('no_jobrequest',null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'noreqjo','required','readonly']) }}
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        {{ Form::label('textalat', 'Kode Alat:') }}
                        {{ Form::select('kode_alat',$Alat->sort(), null, ['class'=> 'form-control select2','required','id'=>'nocontainer','autocomplete'=>'off','style'=>'width: 100%','placeholder'=>'','onchange'=>"tarif();"]) }}
                    </div>
                </div>
                <div class="col-md-12">
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        {{ Form::label('qtyys', 'Hour:') }}
                        {{ Form::text('qty', null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'Qty1','required','onkeyup'=>"hitung();"]) }}
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        {{ Form::label('qtyys', 'Tarif:') }}
                        {{ Form::text('harga', null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'Harga1','readonly']) }}
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        {{ Form::label('qtyys', 'Total:') }}
                        {{ Form::text('subtotal', null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'Subtotal1','readonly']) }}
                    </div>
                </div>
                <div class="col-md-12">
                    <span class="pull-right"> 
                        <br>
                        {{ Form::submit('Add Item', ['class' => 'btn btn-success btn-xs simpans','id'=>'submito']) }}
...
@push('js')
    <script>
        ...
        function tarif(){
            ...
            var total = 0;
            $.ajax({
                url:'{!! route('jobrequestdetail.tarif') !!}',
                type:'POST',
                data : {
                    'kode': kode,
                    'no_joborder': no_jo,
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:link+'/gui_front_02/admin/jobrequestdetail/getDatabyID?id='+no_joborder,
        ...
        $(document).ready(function() {
            ...
            $('#hapusjo').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '{!! route('jobrequestdetail.hapus_noreqjo') !!}',
                            type: 'POST',
                            data : {
            ...
            $('#editjo').click( function () {
                ...
                $.ajax({
                    url: '{!! route('jobrequestdetail.edit_noreqjo') !!}',
                    type: 'POST',
                    data : {
                        'no_jo': no_jo,
                        'no_jobrequest': no_jobrequest,
            ...
            $('#addjobutton').click( function () {
                ...
                $.ajax({
                    url: '{!! route('jobrequestdetail.getDatajor') !!}',
                    type: 'GET',
                    data : {
                        'no_jo': no_jo,
                        'id': no_jor,
            ...
            $('#viewjobreq').click( function () {
                ...
                $.ajax({
                    url: '{!! route('jobrequestdetail.showdetailjobreq') !!}',
                    type: 'POST',
                    data : {
                        'id': no_jobrequest
                    },
            ...
            $('#editjoborderdetail').click( function () {
                ...
                var row = table.row( select );
                $.ajax({
                    url: '{!! route('jobrequestdetail.edit_jobrequest') !!}',
                    type: 'POST',
                    data : {
                        'no_jobrequest': no_jobrequest,
                    },
            ...
            $('#hapusjoborderdetail').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '{!! route('jobrequestdetail.hapus_jobrequest') !!}',
                            type: 'POST',
                            data : {
                                'no_jobrequest': no_jobrequest,
                            },
    ...
    <script>
        ...
        $('#ADD_TRUCKING').submit(function (e) {
            ...
            $.ajax({
                url:'{!! route('jobrequestdetail.store2') !!}',
                type:'POST',
                data:formData,
        ...
        $('#ADD_REQUEST').submit(function (e) {
            ...
            var formData = registerForm.serialize();
            $.ajax({
                url:'{!! route('jobrequestdetail.store') !!}',
                type:'POST',
                data:formData,
                success:function(data) {
                    console.log(data);
        ...
        $('#UPDATE_DETAIL').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                $.ajax({
                    url:'{!! route('jobrequestdetail.updateajax') !!}',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        if(data.success === true) {
